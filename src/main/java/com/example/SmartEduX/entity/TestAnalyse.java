...
public class TestAnalyse {
    ...
    @ApiModelProperty(value = "正确数量", required = true, example = "1")
    private Integer correctquantity;
    @ApiModelProperty(value = "正确率", required = true, example = "1")
    private Float accuracy;
    @ApiModelProperty(value = "正确率建议", required = true, example = "1")
    private String accuracyproposal;
    @ApiModelProperty(value = "知识点建议", required = true, example = "1")
    private String knowledgemasterproposal;
    @ApiModelProperty(value = "推荐课程", required = true, example = "1")
