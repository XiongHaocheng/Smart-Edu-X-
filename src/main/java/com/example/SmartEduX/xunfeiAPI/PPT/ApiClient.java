...
public class ApiClient {
    ...
    public String createPPT(String appId, String timestamp, String signature, String query, String theme, String username) throws IOException {
    ...
    public String createPptBySid(String appId, String timestamp, String signature, String sid) throws IOException {
    ...
    public String createPptByOutline(String appId, String ts, String signature, String query, String outline, String theme, String username) throws IOException {
