package com.example.SmartEduX.xunfeiAPI.BoardHandle;
...
@Api(tags = "API接口")
@RestController
@RequestMapping("boardhandler")
public class BoardHandle {
    private String requestUrl = "https://api.xf-yun.com/v1/private/sf8e6aca1";

    //控制台获取以下信息
    private static String APPID = "df05880c";
    private static String apiSecret = "MmMwOTQxODU3OGExMjE1NTUxZGU2NjFm";
    private static String apiKey = "fe5f129493829f0ebefa5eb380acfdbf";

    //文件存放位置
    private static String IMAGE_PATH = "F:/代码部分/中软杯/Smart-Edu-X-前/src/assets/img/";

    //解析json
    private static Gson gson=new Gson();
    @ApiOperation("板书识别")
    @CrossOrigin
    @GetMapping("/imgrecognize")
    public com.example.SmartEduX.common.Result<?> getBoardImgText(@RequestParam String filename) {
        IMAGE_PATH = "F:/代码部分/中软杯/Smart-Edu-X-前/src/assets/img/";
        IMAGE_PATH += filename;
        BoardHandle demo = new BoardHandle();
        ...
        return com.example.SmartEduX.common.Result.success(jsonObject, "成功");
    }
