package com.example.SmartEduX.xunfeiAPI.TextTranslate;
...
public class MachineTranslationMain {
    ...
    // 控制台获取以下信息
    private static String APPID = "a0a12301";
    private static String APISecret = "ZDU0MjExYTBmNzUwMjlhZDA2ZmNmOWI1";
    private static String APIKey = "fe2f5373eef62b98333cb9372a5dcf35";
    // 术语资源唯一标识，请根据控制台定义的RES_ID替换具体值，如不需术语可以不用传递此参数
    private static final String RES_ID = "its_en_cn_word";
    // 翻译信息
    private static String FROM = "";// 源语种
    private static String TO = "";// 目标语种
    private static String TEXT = "";// 文本内容
    // JSON解析
    ...
    public com.example.SmartEduX.common.Result<?> getTextTranslateResult(@RequestParam String text, @RequestParam String from ,@RequestParam String to) {
        TEXT = text;
        FROM = from;
        TO = to;
