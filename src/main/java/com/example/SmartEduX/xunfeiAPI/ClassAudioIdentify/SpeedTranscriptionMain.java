...
public class SpeedTranscriptionMain {
    // 控制台获取以下信息
    private static String APP_ID = "3a6ddc40";
    private static String API_SECRET = "MjQ3Y2ZjZDU3M2ExY2ZhODJhNTExNTlm";
    private static String API_KEY = "3dce4079d9325592fad23153548e74cc";
