...
public class BigModelNew extends WebSocketListener {
    ...
    public static final String appid = "706fd162";
    public static final String apiSecret = "NDZjMGE2YTBhZjg1MWZmODIxMjFjNDA0";
    public static final String apiKey = "f00704f58aae06db259672e6007bcd70";
    ...
    public static boolean allContentAdded = false; // 标志位，表示是否所有内容都已经添加完毕
    // 个性化参数
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 等待totalAnswer被更新
        while (totalAnswer.isEmpty() || allContentAdded == false) {
            Thread.sleep(4000);
        }
        // 这里可以使用totalAnswer了
        //System.out.println("Total Answer: " + totalAnswer);
        QAndAController.answer = totalAnswer;
    }
